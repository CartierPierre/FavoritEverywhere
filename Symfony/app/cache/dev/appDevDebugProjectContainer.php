...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/FE/FavorisBundle/Entity'), 1 => ($this->targetDirs[3].'/src/FE/UserBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'FE\\FavorisBundle\\Entity');
        $c->addDriver($b, 'FE\\UserBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('FEFavorisBundle' => 'FE\\FavorisBundle\\Entity', 'UserBundle' => 'FE\\UserBundle\\Entity'));
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j->setOptions(array('always_use_default_target_path' => false, 'default_target_path' => '/', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
