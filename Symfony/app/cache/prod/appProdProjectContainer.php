...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_sqlite', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'ak.db', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'path' => ($this->targetDirs[2].'/database.db'), 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/FE/UserBundle/Resources/config/doctrine') => 'FE\\UserBundle\\Entity'));
        $a->setGlobalBasename('mapping');
        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/FE/FavorisBundle/Entity'))), 'FE\\FavorisBundle\\Entity');
        $b->addDriver($a, 'FE\\UserBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('FEFavorisBundle' => 'FE\\FavorisBundle\\Entity', 'UserBundle' => 'FE\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e69829323838d12c6325cd957738dde1c40086f5b74648838b31592236a7c867');
        return $instance;
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('FE\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('FE\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('FE\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('FE\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'FE\\UserBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $n = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'b4289c0b750d5c5b573788d79c4e1d130380ff7d', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
        ...
        $p->setOptions(array('login_path' => 'fos_user_security_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->setFallbackLocales(array(0 => 'fr_FR'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/FE/AccountBundle/Resources/views'), 'FEAccount');
        $instance->addPath(($this->targetDirs[3].'/src/FE/FavorisBundle/Resources/views'), 'FEFavoris');
        $instance->addPath(($this->targetDirs[3].'/src/FE/GeneralBundle/Resources/views'), 'FEGeneral');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/FE/UserBundle/Resources/views'), 'User');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b4289c0b750d5c5b573788d79c4e1d130380ff7d');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FEAccountBundle' => 'FE\\AccountBundle\\FEAccountBundle',
                'FEFavorisBundle' => 'FE\\FavorisBundle\\FEFavorisBundle',
                'FEGeneralBundle' => 'FE\\GeneralBundle\\FEGeneralBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'UserBundle' => 'FE\\UserBundle\\UserBundle',
            ),
            ...
            'kernel.secret' => 'b4289c0b750d5c5b573788d79c4e1d130380ff7d',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'smtp.msm.com',
            ...
            'fos_user.model.user.class' => 'FE\\UserBundle\\Entity\\User',
